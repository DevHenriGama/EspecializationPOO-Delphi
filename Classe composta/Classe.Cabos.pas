unit Classe.Cabos;
{* A composição de Classe Acontece quando ultilizamos outras classe para montar outra
Exemplo bem simple , mas poderiamos evolui-lo e colocar função de busca em um DB paran
